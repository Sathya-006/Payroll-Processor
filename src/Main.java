public class Main {
    public static void main(String[] args) {
        SalariesEmployee pay = new SalariesEmployee("Sathya",50000);
        HourlyEmployee hour =new HourlyEmployee("Madhu",20.0,60.0);
        System.out.println("Salaried Employee: " + pay.getName());
        System.out.println("Monthly Salary: $" + pay.calculatepay());
        System.out.println("\nHourly Employee: " +hour.getName());
